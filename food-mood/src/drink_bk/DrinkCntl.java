...
public class DrinkCntl extends EntryCntl {
     ...
     *
     * @param db Drink_bk model for MVC architecture.
     * @param drinkView DrinkView for MVC architecture.
     * @param accountID
     */
    public DrinkCntl(int accountID, Drink_Table_bk db, DrinkView drinkView) {
        this.db = db;
    ...
    class SubmitButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            Drink_bk newDrink = new Drink_bk(name, portion, dt.format(new Date()), 1);
    ...
    public Drink_bk getDrink() {
        return drink;
    }

    public void setDrink(Drink_bk drink) {
        this.drink = drink;
    }
