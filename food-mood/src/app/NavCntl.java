...
import DesignSelection.FoodMoodEntryFormView;
...
public class NavCntl {
    ...
    private FoodMoodEntryFormView foodMoodEntryFormView;
    private FoodMoodEntryFormCntl foodMoodEntryFormCntl;
    ...
    public class NewEntryCntlListener implements ActionListener {
        ...
        @Override
        public void actionPerformed(ActionEvent e) {
            FoodMoodEntryFormView foodMoodEntryFormView = new FoodMoodEntryFormView();
            FoodMoodEntryFormCntl foodMoodEntryFormCntl = new FoodMoodEntryFormCntl(foodMoodEntryFormView);
        }
    }
    ...
    public FoodMoodEntryFormView getFoodMoodEntryFormView() {
        return foodMoodEntryFormView;
    }

    public FoodMoodEntryFormCntl getFoodMoodEntryFormCntl() {
        return foodMoodEntryFormCntl;
    }
